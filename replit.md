...
- June 30, 2025. Added "Создать" button to Documents module: Implemented create button in the header section of documents page with Plus icon. Button is positioned in top-right corner next to page title. Functionality is currently a placeholder - button exists but performs no actions yet.
