...
- June 30, 2025. Optimized document form field layout: Redesigned document item grid from 5 to 6 columns with improved proportions. Product field now spans 3 columns (50% width) to fully display product names. Quantity and price fields each span 1 column with compact labels ("Кол-во" instead of "Количество"). Delete button spans 1 column for balanced layout. Fields now properly sized for better usability and readability.
