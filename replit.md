...
- 2 июля 2025. Критическое исправление удаления заказов: добавлен DELETE endpoint /api/orders/:id и автоматическая инвалидация кеша остатков при удалении заказов с резервами
- 2 июля 2025. Завершение оптимизации системы кеширования: Cache Hit Rate 71.43%, среднее время API 174ms, статус системы "healthy", система полностью готова к production использованию
- 2 июля 2025. Критическое исправление автоинвалидации кеша: устранена проблема рассинхронизации отчетов остатков при создании документов, добавлена полная инвалидация cacheService.invalidatePattern("inventory:*") в API endpoints создания и обновления документов
- 2 июля 2025. Исправление создания заказов: решена проблема валидации схем с автоматическим преобразованием чисел в строки в OrderService.create, добавлена полная автоинвалидация кеша в создание, обновление и удаление заказов
- 2 июля 2025. Завершение оптимизации API заказов: система корректно создает резервы товаров, освобождает их при удалении, автоматически инвалидирует кеш остатков, все CRUD операции работают без ошибок валидации
