...
- 2 июля 2025. Архитектура тестов в порядке: Unit-тесты покрывают все ключевые компоненты, интеграционные тесты работают идеально, автотест адаптивности (runSystemTest.sh) стабильно проходит все проверки
