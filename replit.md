...
- June 30, 2025. Fixed product selection display issue in Document component: Replaced Radix UI Select component with standard HTML select element to resolve problem where selected product names weren't displaying correctly in dropdown field. Applied identical Tailwind CSS styling to maintain visual consistency. Product selection now works reliably across all browsers and shows selected product names properly.
