...
- 3 июля 2025. Завершение архитектурной защиты: создан интеграционный тест заказов tests/integration/orders.test.ts для проверки POST /api/orders/create, обновлена ARCHITECTURE.md с информацией о централизованных API хуках и обязательных правилах тестирования
