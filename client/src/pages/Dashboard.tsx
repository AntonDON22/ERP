      ...
      updates: [
        {
          ...
          description: "Созданы материализованные представления inventory_summary и inventory_availability для ускорения запросов к остаткам в 10-20 раз. Добавлена панель администратора для управления представлениями. Система автоматически переключается между быстрыми представлениями и прямыми запросами при необходимости"
        },
        {
          time: "14:18",
          type: "improvement",
