...
- 3 июля 2025. Завершение масштабного рефакторинга сервисного слоя: все основные сервисы (ContractorService, WarehouseService, SupplierService, ProductService, DocumentService, OrderService) мигрированы на наследование от BaseService с generic-типами, устранено дублирование ~300+ строк CRUD-логики, достигнута консистентность архитектуры через единые interfaces и validateImportData методы
